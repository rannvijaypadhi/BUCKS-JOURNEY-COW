...
const scenes = [
    ...
    },
    {
        ...
        chapterTitle: "Stolen From Home",
        type: "story",
        text: "Snow crunches under boots. A man in a red sweater waits, holding a club.\n\nThe club is more than wood. What does it symbolize to you?",
        choices: [
            { text: "Power humans have over animals", effects: { loyalty: -1, wildness: +1 }, next: 33 },
            { text: "The law of this new world", effects: { survival: +1 }, next: 4 },
            { text: "The death of your old life", effects: { morale: -1, wildness: +1 }, next: 23 },
            { text: "A test you must survive", effects: { survival: +1, respect: +1 }, next: 4 }
        ]
    },
    {
        id: 33,
        ...
        chapterTitle: "Stolen From Home",
        type: "story",
        text: "You stare at the club, feeling its meaning sink in.\n\nIf the club is power, what are you?",
        choices: [
            { text: "A victim of that power", effects: { morale: -1, loyalty: -1 }, next: 4 },
            { text: "A challenger to that power", effects: { wildness: +2, respect: +1 }, next: 4 },
            { text: "A survivor beneath that power", effects: { survival: +2 }, next: 4 },
            { text: "Something that will outgrow that power", effects: { wildness: +1, survival: +1 }, next: 4 }
        ]
    },
    {
        id: 23,
    ...
    },
    {
        ...
        chapterTitle: "Stolen From Home",
        type: "story",
        text: "Bruised and panting, you lie in the snow.\n\nThe snow around you is stained with drops of blood. What does that blood mean?",
        choices: [
            { text: "The price of learning the law", effects: { survival: +1 }, next: 5 },
            { text: "The death of who you were", effects: { wildness: +1, morale: -1 }, next: 5 },
            { text: "A warning to anyone who underestimates you", effects: { respect: +1, wildness: +1 }, next: 5 },
            { text: "Just blood. You refuse to give it meaning.", effects: { fatigue: +1 }, next: 5 }
        ]
    },
    ...
    },
    {
        ...
        choices: [
            { text: "A shield", effects: { survival: +1, wildness: +1 }, next: 35 },
    ...
    },
    {
        ...
        chapterTitle: "The Law of Club",
        type: "story",
        text: "You watch the others from a distance.\n\nIf isolation is a shield, what are you shielding?",
        choices: [
            { text: "Your heart", effects: { morale: -1, loyalty: +1 }, next: 6 },
            { text: "Your wildness", effects: { wildness: +2 }, next: 6 },
            { text: "Your chances of survival", effects: { survival: +2 }, next: 6 },
            { text: "You don't know. You just stay apart.", effects: { fatigue: +1 }, next: 6 }
        ]
    },
    {
        id: 6,
    ...
    },
    {
        ...
        choices: [
            { text: "Stronger. You had no choice.", effects: { survival: +1, morale: -1 }, next: 36 },
    ...
    },
    {
        ...
        chapterTitle: "The Law of Club",
        type: "story",
        text: "The trail stretches ahead, white and endless.\n\nWhat does the endless snow symbolize to you now?",
        choices: [
            { text: "A test that never ends", effects: { fatigue: +1, survival: +1 }, next: 8 },
            { text: "A blank page you are forced to write on", effects: { morale: -1, wildness: +1 }, next: 8 },
            { text: "A graveyard for the weak", effects: { wildness: +1, respect: +1 }, next: 8 },
            { text: "A place where you might become something new", effects: { survival: +1, morale: +1 }, next: 8 }
        ]
    },
    ...
    },
    {
        ...
        choices: [
            { text: "Unstable. You feel torn.", effects: { morale: -1 }, next: 37 },
    ...
    },
    {
        ...
        chapterTitle: "The Sled Team",
        type: "story",
        text: "You feel split between the house-dog you were and the wolf you might become.\n\nIf Buck is a symbol, what does he represent now?",
        choices: [
            { text: "The struggle between comfort and freedom", effects: { morale: +1 }, next: 9 },
            { text: "The cost of survival in a harsh world", effects: { survival: +1 }, next: 9 },
            { text: "The wildness hidden inside anything tame", effects: { wildness: +2 }, next: 9 },
            { text: "You refuse to be a symbol. You are just you.", effects: { respect: +1 }, next: 9 }
        ]
    },
    {
        id: 9,
    ...
    },
    {
        ...
        chapterTitle: "The Sled Team",
        type: "story",
        text: "You feel power in your limbs. The pack senses your rising strength.\n\nIf Spitz is a symbol, what does he represent to you now?",
        choices: [
            { text: "Fear that must be faced", effects: { morale: +1, survival: +1 }, next: 12 },
            { text: "The old law that must fall", effects: { wildness: +2 }, next: 12 },
            { text: "The part of you that still clings to the past", effects: { loyalty: -1, wildness: +1 }, next: 12 },
            { text: "Just another rival in the snow", effects: { respect: +1 }, next: 12 }
        ]
    },
    {
        id: 11,
    ...
    },
    {
        ...
        choices: [
            { text: "A burden", effects: { fatigue: +1, survival: +1 }, next: 38 },
    ...
    },
    {
        ...
        chapterTitle: "The Fight for Leadership",
        type: "story",
        text: "The traces, the pack, the trail—all of it rests on you.\n\nIf leadership is a symbol, what does it represent in your journey?",
        choices: [
            { text: "Responsibility for more than yourself", effects: { loyalty: +1, respect: +1 }, next: 14 },
            { text: "The price of power", effects: { wildness: +1, fatigue: +1 }, next: 14 },
            { text: "The moment you stop being just an animal", effects: { morale: +1 }, next: 14 },
            { text: "A role you never asked for", effects: { fatigue: +1, survival: +1 }, next: 14 }
        ]
    },
    {
        id: 14,
    ...
    },
    {
        ...
        chapterTitle: "The Call of the Wild",
        type: "story",
        text: "You stand at the edge of the forest, feeling both the camp and the wild behind you.\n\nIf the forest is a symbol, what does it represent now?",
        choices: [
            { text: "Freedom, no matter the cost", effects: { wildness: +2 }, next: 16 },
            { text: "Danger that might still be worth it", effects: { survival: +1 }, next: 16 },
            { text: "A future you aren't ready for", effects: { morale: -1 }, next: 16 },
            { text: "A mirror of the wildness inside you", effects: { wildness: +1, respect: +1 }, next: 16 }
        ]
    },
    ...
    },
    {
        ...
        choices: [
            { text: "A weight", effects: { fatigue: +1, morale: -1 }, next: 40 },
    ...
    },
    {
        ...
        chapterTitle: "Thornton",
        type: "story",
        text: "The camp is gone, but his scent lingers.\n\nIf Thornton is a symbol, what does he represent in your story?",
        choices: [
            { text: "The last light of human kindness", effects: { loyalty: +2, morale: +1 }, next: 17 },
            { text: "A fragile shelter that could never last", effects: { survival: +1, morale: -1 }, next: 17 },
            { text: "The part of you that still loves the tame world", effects: { loyalty: +1, wildness: -1 }, next: 17 },
            { text: "A chapter that had to end", effects: { wildness: +1 }, next: 17 }
        ]
    },
    {
        id: 17,
    ...
    },
    {
        ...
        chapterTitle: "Blood on the Snow",
        type: "story",
        text: "The fire dies. The bodies lie still. Snow begins to fall again.\n\nWhat does this blood on the snow symbolize to you?",
        choices: [
            { text: "The end of your life with humans", effects: { wildness: +2 }, next: 19 },
            { text: "The cost of love and loyalty", effects: { loyalty: +1, morale: -1 }, next: 19 },
            { text: "A warning to anyone who harms what you love", effects: { respect: +1, wildness: +1 }, next: 19 },
            { text: "A final tie cut between two worlds", effects: { survival: +1 }, next: 19 }
        ]
    },
    {
        id: 19,
